...
module Users
  class RegistrationsController < Devise::RegistrationsController
    ...
    def configure_sign_up_params
      devise_parameter_sanitizer.permit(:sign_up, keys: %i[name surname authorization_tier image])
    end

    # If you have extra params to permit, append them to the sanitizer.
    def configure_account_update_params
      devise_parameter_sanitizer.permit(:account_update, keys: %i[name surname security_updates image])
    end
